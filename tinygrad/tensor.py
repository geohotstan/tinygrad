...
class Tensor:
  ...
  def __getitem__(self, val):
    ...
    if tensor_found: # Fancy/tensor indexing
      ...
      idx = [(Tensor([0], dtype=dtypes.int32) - i[1].sign()).maximum(Tensor([0], dtype=dtypes.int32)) * Tensor([ret.shape[i[0]]], dtype=dtypes.int32) + Tensor([i[1]], dtype=dtypes.int32) for i in tensor_found]
